...
describe("calcularFizzBuzz", () => {
  ...
  it("Si el numero es multiplo de 3 y de 5 deberia devolver FizzBuzz", () => {
    expect(calcularFizzBuzz(15)).toEqual("FizzBuzz");
  });

  it("Si el numero es multiplo de 3 y de 5 deberia devolver FizzBuzz", () => {
    expect(calcularFizzBuzz(30)).toEqual("FizzBuzz");
  });
